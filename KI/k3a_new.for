...
c	masses
 ...
 30   AMP=AMP-INC  
      ...
      GAM=DK2/MCL+(1.0d0/8.0d0)*K4*AMP**2/MCL*(-3.306D0)
...
C	      ftor =  (1.0d0+(K3**2/(2.0d0*K4))*G0)
		  FTOR = (1.0d0+(K3**2/(K4*MCL))*89.7875D0*(F10-F20))
			PRINT*, FTOR

            GAM1=DK2/MCL+(1.0d0/8.0d0)*K4*AMP**2/MCL*ftor
			print*,'condition ' ,GAM1,AMP
