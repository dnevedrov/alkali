c     last updated 06/09/2000 by Dmitri Nevedrov
     ...
     *     INC,TMP(NW),GAM,B,WMAX,ftor,F10,F20
...
C	      ftor =  (1.0d0+(K3**2/(2.0d0*K4))*G0)
		  FTOR = (1.0d0+(K3**2/(K4*MCL))*41.688D0*(F10-F20))
			PRINT*, (K3**2/(K4*K2)),41.688D0*(F10-F20)
