...
C	STOP
      ...
      M2 = MCL
 30   AMP=AMP-INC  
       GAM=DK2/MCL+(1.0d0/12.0d0)*K4*AMP**2/MCL*(-3.0938D0)
C     *	 *(1.0d0-(K3**2/(K2*K4)))
      ...
      DO K=1,NW
	   B=(1.0D0-MD/MCL)*OMEGA(K)**2+2.0D0*GAM    
         ...
         if (k.eq.1) then
	      ...
	      ftor =  (1.0d0+(K3**2/(MCL*K4))*100.21D0*(F10-F20))
...
C     ================================================
 ...
 2    FORMAT(3E16.8)
      ...
      INTEGER I1,I2,I
      COMPLEX*16 GG(9,9),TMP(9,9),GG0(9,9),G(36,1609),DC,W(9,9),
     *     AL,BE,KOFF,GG1(3,3),GG2(3,3),GG3(3,3)
      CHARACTER*1 TR
      AL=DCMPLX(1.0D0,0.0D0)
      BE=DCMPLX(0.0D0,0.0D0)
      TR='N'
      KOFF=DCMPLX(100.21D0,0.0D0)
      GG1(1,1) = KOFF*G(12,I)
      GG1(1,2) = KOFF*G(10,I)
      GG1(1,3) = KOFF*G(10,I)
      GG1(2,1) = KOFF*G(10,I)
