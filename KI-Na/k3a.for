...
c	masses
 ...
 30   AMP=AMP-INC  
      ...
      GAM=DK2/MCL+(1.0d0/4.0d0)*K4*AMP**2/MCL*(-0.3383D0)
       print*, DK2/MCL,(1.0d0/4.0d0)*K4*AMP**2/MCL*(-0.3383D0)
 100  DO J=1,9
         DO I=1,9
...
C	      ftor =  (1.0d0+(K3**2/(2.0d0*K4))*G0)
		  FTOR = (1.0d0+(K3**2/(K4*MCL))*89.96D0*(F10-F20))
			PRINT*, FTOR
...
C     ================================================
      CALL MAZ(TMP,M)
      PRINT*,'AMP   ',AMP*1.0D10,OMEGA(M)/WMAX,  FTOR
 ...
 2    FORMAT(3E16.8)
      ...
      INTEGER I1,I2,I
      COMPLEX*16 GG(9,9),TMP(9,9),GG0(9,9),G(36,1129),DC,W(9,9),
     *     AL,BE,KOFF,GG1(3,3),GG2(3,3),GG3(3,3)
      CHARACTER*1 TR
      AL=DCMPLX(1.0D0,0.0D0)
      BE=DCMPLX(0.0D0,0.0D0)
      TR='N'
      KOFF=DCMPLX(89.96D0,0.0D0)
      GG1(1,1) = KOFF*G(12,I)
      GG1(1,2) = KOFF*G(10,I)
      GG1(1,3) = KOFF*G(10,I)
      GG1(2,1) = KOFF*G(10,I)
